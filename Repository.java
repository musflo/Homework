	...
	private static Product[] getListOfProducts(String aisleNumber) {
		...
		if (aisleNumber.equals("3")) {
			Product item1 = new Product("009", "Jackie Chan", 989.49f, 1);
			Product item2 = new Product("010", "Steven Seagal", 1.49f, 1);
			Product item3 = new Product("011", "Dolph Lundgren", 10.49f, 0);
			Product item4 = new Product("012", "Carl Weathers", 34.49f, 1);
			return new Product[] {item1, item2, item3, item4};
		}
		if (aisleNumber.equals("4")) {
			Product item1 = new Product("013", "Small Bottle", 1.49f, 6);
			Product item2 = new Product("014", "Gallon-size", 3.49f, 6);
			Product item3 = new Product("015", "5-Gallon Hat", 50.49f, 5);
			Product item4 = new Product("016", "Waterless", 494.49f, 0);
			return new Product[] {item1, item2, item3, item4};
		}
